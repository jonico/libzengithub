...
# libzengithub - an example how to build portable [conan.io](https://www.conan.io/) C/C++ packages with mutliple CIs on multiple operating systems, target architectures and build flags
